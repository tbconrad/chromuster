...
// ***********************************************************************
// <copyright file="TestStateDbSet.cs" company="Conrad Enterprise, Inc.">
...
{
    /// <summary>
    /// Class TestStateDbSet.
    /// </summary>
    /// <seealso cref="WidgetTestService.Tests.TestDbSet{WidgetTestService.Models.State}" />
    class TestStateDbSet : TestDbSet<State>
    {
        /// <summary>
        ...
        public override State Find(params object[] keyValues)
        {
            return this.SingleOrDefault(s => s.StateId == (int)keyValues.Single());
        }
    }
}
