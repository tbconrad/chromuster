...
// ***********************************************************************
// <copyright file="TestWidgetDbSet.cs" company="Conrad Enterprise, Inc.">
...
{
    /// <summary>
    /// Class TestWidgetDbSet.
    /// </summary>
    /// <seealso cref="WidgetTestService.Tests.TestDbSet{WidgetTestService.Models.Widget}" />
    class TestWidgetDbSet : TestDbSet<Widget>
    {
        /// <summary>
        ...
        public override Widget Find(params object[] keyValues)
        {
            return this.SingleOrDefault(s => s.WidgetId == (int)keyValues.Single());
        }
    }
}
