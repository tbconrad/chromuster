...
// ***********************************************************************
// <copyright file="TestOrderDbSet.cs" company="Conrad Enterprise, Inc.">
...
{
    /// <summary>
    /// Class TestOrderDbSet.
    /// </summary>
    /// <seealso cref="WidgetTestService.Tests.TestDbSet{WidgetTestService.Models.Order}" />
    class TestOrderDbSet : TestDbSet<Order>
    {
        ...
        {
            return this.SingleOrDefault(s => s.OrderId == (int)keyValues.Single());
        }
    }
}
