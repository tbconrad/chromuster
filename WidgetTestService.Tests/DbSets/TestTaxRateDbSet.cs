...
// ***********************************************************************
// <copyright file="TestTaxRateDbSet.cs" company="Conrad Enterprise, Inc.">
...
{
    /// <summary>
    /// Class TestTaxRateDbSet.
    /// </summary>
    /// <seealso cref="WidgetTestService.Tests.TestDbSet{WidgetTestService.Models.TaxRate}" />
    class TestTaxRateDbSet : TestDbSet<TaxRate>
    {
        /// <summary>
        ...
        public override TaxRate Find(params object[] keyValues)
        {
            return this.SingleOrDefault(s => s.TaxRateId == (int)keyValues.Single());
        }
    }
}
