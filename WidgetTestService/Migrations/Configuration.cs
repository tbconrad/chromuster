...
// ***********************************************************************
// <copyright file="Configuration.cs" company="Conrad Enterprise, Inc.">
...
namespace WidgetTestService.Migrations
{
    ...
    /// </summary>
    /// <seealso cref="WidgetContext" />
    internal sealed class Configuration : DbMigrationsConfiguration<WidgetTestService.DAL.WidgetContext>
    {
        /// <summary>
        ...
        protected override void Seed(WidgetContext context)
        {
            ...
            context.Widgets.AddOrUpdate(x => x.WidgetId,
                ...
                new Widget() { WidgetId = 11, Name = "Zonecof-Widget", BasePrice = 8.95, DiscountAvailable = true, CreatedBy = "Tim Conrad", Created = DateTime.Parse("11/8/2016"), DiscountId = 2 },
